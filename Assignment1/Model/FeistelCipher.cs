...
{
    /// <summary>
    /// For a discussion of what a Feistel cipher is, and the process that this class runs through, 
    /// see chapter 1.1 in the report
    /// </summary>
    public class FeistelCipher
    {
        ...
        /// <summary>
        /// This method and the methods which is called inside it is discussed in chapter 2.2.3.1 of the report
        /// </summary>
        /// <param name="input">Inputted plain or cipher text</param>
        /// <param name="key">Inputted key</param>
        /// <param name="isEncrypt">true if encryption should be performed, false otherwise</param>
        public void Execute(string input, string key, bool isEncrypt)
        {
            ...
            // The following is used for speed testing purposes
