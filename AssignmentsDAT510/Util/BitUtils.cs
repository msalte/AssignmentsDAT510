...
namespace AssignmentsDAT510.Util
{
    ...
    public static class BitUtils
    {
        ...
        public static BitSequence BinaryStringToBitSequence(string binaryString)
        {
            var bitSequence = new BitSequence(binaryString.Length);

            for (var i = 0; i < binaryString.Length; i++)
            {
                bitSequence.Set(i, binaryString[i] == '1');
            }
